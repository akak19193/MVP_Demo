...
public class ArrowRefreshHeader extends LinearLayout implements BaseRefreshHeader {
    ...
    private void initView() {
        ...
        progressView.setIndicatorId(new RandomNumberUtil().getRandomNumber(0, 27));
    ...
    public static String friendlyTime(Date time) {
        ...
        if(ct > 0 && ct < 60) {
            return ct + "second(s) ago";
        }

        if(ct >= 60 && ct < 3600) {
            return Math.max(ct / 60,1) + "minute(s) ago";
        }
        if(ct >= 3600 && ct < 86400)
            return ct / 3600 + "hour(s) ago";
        if(ct >= 86400 && ct < 2592000){ //86400 * 30
            int day = ct / 86400 ;
            return day + "day(s) ago";
        }
        if(ct >= 2592000 && ct < 31104000) { //86400 * 30
            return ct / 2592000 + "(month(s) ago)";
        }
        return ct / 31104000 + "year(s) ago";
    }
