...
import app.com.uicollections.android.mvp_demo.common.loading.VaryViewHelperController;
...
public abstract class BaseFragment<T extends BasePresenter> extends Fragment implements
    ...
    protected void setToolbar(boolean isNeedMenuImg, boolean isNeedBackImg, String titleContent) {
        if (mToolbar != null) {
            if (isNeedBackImg) {
            ...
            if (isNeedMenuImg) {
                ...
                mToolbar.setNavigationOnClickListener(v -> onMenuClick());
            }
